...
This package provides a compiled version of the C <strong><a
href="http://www.htslib.org/" target="_blank"><code
style="font-size:150%">htslib</code></a></strong> for high-throughput
sequence analysis. It is primarily useful to developers of other R
packages who want to use the htslib facilities in the C code of their
own packages.
